...
type AssignReferencesOptionsOld struct {
...
func AssignReferencesOld(ctx context.Context, opts *AssignReferencesOptionsOld, wof_id int64, refs ...*Reference) ([]byte, error) {
